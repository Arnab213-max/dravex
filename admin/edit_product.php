...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        executeQuery("UPDATE products SET category_id = $form_data[category_id], name = '$form_data[name]', description = '$form_data[description]', price = $form_data[price], discount_price = $discount, quantity = $form_data[quantity], image = '$image_name' WHERE id = $product_id");
...
<div class="admin-container">
    <h2 class="page-title"><i class="fas fa-edit" style="color:var(--gold);"></i> Edit Product</h2>
    <form method="POST" enctype="multipart/form-data" class="glass-form" style="max-width:800px;">
        ...
        <div class="form-group">
            ...
            <div style="margin:10px 0;">
                <img src="../uploads/<?php echo htmlspecialchars($product['image']); ?>" style="width:100px; height:100px; object-fit:cover; border-radius:8px; border:2px solid rgba(212,175,55,0.2);">
            </div>
